...
#    NOTE      : If the environment variable is set appropriately for Python interpreter, then precede the above command # #                 with the keyword "python". i.e python id3.py <train_file_name> <test_file_name> 
